 ...
 *
 * This makes use of [System.getenv].
 */
public actual object Environment {
    /**
     * Returns the environment variable with the given [name], or `null` if none is found.
     *
     * Note that whether an environment variable is case-sensitive or not is implementation specific.
     *
     * @see [System.getenv]
     */
    public actual operator fun get(name: String): String? = System.getenv(name)
     ...
     * @see [System.getenv]
     */
    public actual fun toMap(): Map<String, String> = System.getenv()
}